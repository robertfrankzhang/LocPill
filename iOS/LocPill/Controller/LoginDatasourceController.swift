//
//  LoginDatasourceController.swift
//  LocPill
//
...
class LoginDatasourceController:UIViewController, UITextFieldDelegate{
    static var own:LoginDatasourceController = LoginDatasourceController()
    ...
    lazy var passwordTextField:UITextField = {
        let tf = UITextField()
        tf.placeholder = "Set Password (at least 6 characters)"
    ...
    override func viewDidLoad() {
        LoginDatasourceController.own = self
        view.backgroundColor = ThemeColor.white
        
        let logo = UIImageView(image: #imageLiteral(resourceName: "LocPill"))
